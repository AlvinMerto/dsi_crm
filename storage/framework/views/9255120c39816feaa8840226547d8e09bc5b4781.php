    ...
    <div>
        ...
        <div class="btn-group mb-2 me-2">
            <button class="btn  btn-primary dropdown-toggle" type="button" data-bs-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false"><i class="ti ti-printer"></i></button>
            <div class="dropdown-menu dropdown-menu-dark">
                <a class="dropdown-item" href="<?php echo e(route('salesquote.pdf',['id'=> \Crypt::encrypt($salesquote->id),'type'=>'print'])); ?>">Print</a>
                <a class="dropdown-item" target="_blank" href="<?php echo e(route('salesquote.pdf',['id'=> \Crypt::encrypt($salesquote->id),'type'=>'pdf'])); ?>">PDF</a>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/client/dimensionsystem/main-file/Modules/Sales/Resources/views/salesquote/show.blade.php ENDPATH**/ ?>