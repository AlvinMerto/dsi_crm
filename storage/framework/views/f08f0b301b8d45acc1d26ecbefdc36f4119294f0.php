                                    ...
                                    <?php if(!empty($customFields) && count($purchase->customField)>0): ?>
                                        <?php $__currentLoopData = $customFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td class="text-right" style="white-space: normal;"> <?php echo e(!empty($purchase->customField)?$purchase->customField[$field->id]:'-'); ?></td>
                                            </tr>
...
<?php /**PATH /home/dimensionsystems/webcrm.dimensionsystems.com/Modules/Pos/Resources/views/purchase/templates/template1.blade.php ENDPATH**/ ?>