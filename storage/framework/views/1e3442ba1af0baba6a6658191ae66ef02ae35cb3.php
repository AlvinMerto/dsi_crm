<?php echo e(Form::open(['url' => 'quote', 'method' => 'post', 'enctype' => 'multipart/form-data'])); ?>
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <?php echo e(Form::select('opportunity',$opportunities, null , ['id' => 'opportunity','class'=>"form-control choices",'searchEnabled'=>'true','placeholder' => __('Select Opportunity')])); ?>
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <?php echo e(Form::date('date_quoted', date('Y-m-d'), ['class' => 'form-control', 'required' => 'required','placeholder' => 'Date Quoted'])); ?>
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <?php echo e(Form::text('quote_number',$quote_number, ['class' => 'form-control', 'placeholder' => __('Enter Quote Number'), 'required' => 'required','readonly'])); ?>
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <select class="form-control <?php echo e(!empty($errors->first('billing_contact')) ? 'is-invalid' : ''); ?> contact_data"
                            name="billing_contact" id="billing_contact">
                    </select>
                    <div class="invalid-feedback">
                        <?php echo e($errors->first('billing_contact')); ?>
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <select class="form-control <?php echo e(!empty($errors->first('shipping_contact')) ? 'is-invalid' : ''); ?> contact_data"
                            name="shipping_contact" id="shipping_contact">
                    </select>
                    <div class="invalid-feedback">
                        <?php echo e($errors->first('shipping_contact')); ?>
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <?php echo e(Form::select('tax[]', $tax,null, array('class' => 'form-control choices','id'=>'choices-multiple1','multiple'=>''))); ?>
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <?php echo Form::select('shipping_provider', $shipping_provider, null, ['class' => 'form-control '  ,'placeholder' => 'Shipping Provider']); ?>
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <?php echo Form::select('user', $user, null, ['class' => 'form-control', 'required' => 'required ','placeholder' => __('Select User')]); ?>
    ...
    <div class="modal-footer">
        ...
        <?php echo e(Form::submit(__('Save'), ['class' => 'btn btn-primary','id'=>'submit'])); ?>
...
<?php /**PATH /home/dimensionsystems/webcrm.dimensionsystems.com/Modules/Sales/Resources/views/quote/create.blade.php ENDPATH**/ ?>