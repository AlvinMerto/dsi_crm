                    ...
                    <div class="table-responsive overflow_hidden">
                        <table class="table mb-0 pc-dt-simple" id="assets">
                            ...
                            <?php $__currentLoopData = $salesquotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salesquote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <a href="<?php echo e(route('salesquote.show',encrypt($salesquote->id))); ?>" class="btn btn-outline-primary"><?php echo e(\Modules\Sales\Entities\SalesQuote::quoteNumberFormat($salesquote->quote_id)); ?></a>
                                    </td>
                                    ...
                                    <td><?php echo e(currency_format_with_sym($salesquote->getTotalTax() + $salesquote->totalextend())); ?></td>
                                    ...
                                    <!--                    aria-haspopup="true" aria-expanded="false"><?php echo e($quotestatus); ?></button>-->
                                    <!--            <div class="dropdown-menu">-->
                                    <!--                <a class="dropdown-item" href="<?php echo e(route('salesquote.email',['id'=>encrypt($salesquote->id),'type'=>'accept'])); ?>">Accept</a>-->
                                    <!--                <a class="dropdown-item" href="<?php echo e(route('salesquote.email',['id'=>encrypt($salesquote->id),'type'=>'reject'])); ?>">Reject</a>-->
                                    <!--            </div>-->
                                    <!--        </div>-->
                                    <!--    </td>-->
                                    <!--<?php endif; ?>-->
                                        ...
                                        <td class="Action">
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('salesquote edit')): ?>
                                                <div class="action-btn bg-info ms-2">
                                                    <a href="<?php echo e(route('salesquote.edit', \Crypt::encrypt($salesquote->id))); ?>"
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dimensionsystems/webcrm.dimensionsystems.com/Modules/Sales/Resources/views/salesquote/index.blade.php ENDPATH**/ ?>