    ...
    <script>
        $(document).on('change', "[name='proposal_type_radio']", function() {
            ...
            if (val == 'product') {
                ...
                var label =
                    ` <?php echo e(Form::label('project', __('Project'), ['class' => 'form-label'])); ?> <?php echo e(Form::select('project', $projects, null, ['class' => 'form-control ', 'required' => 'required'])); ?>`
                $(".proposal_div").append(label);
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <?php echo e(Form::open(['url' => 'proposal', 'class' => 'w-100'])); ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="customer-box">
                                <?php echo e(Form::label('customer_id', __('Customer/Client'), ['class' => 'form-label'])); ?>
                                            ...
                                            <div class="d-flex radio-check">
                                                <div class="form-check form-check-inline form-group col-md-3">
                                                    ...
                                                    <label class="custom-control-label "
                                                        for="product"><?php echo e(__('Item Wise')); ?></label>
                                                </div>
                                                <div class="form-check form-check-inline form-group col-md-3">
                                                    <input type="radio" id="project1" value="project"
                                                        name="proposal_type_radio" class="form-check-input code">
                                                    <label class="custom-control-label"
                                                        for="project1"><?php echo e(__('Project Wise')); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dimensionsystems/webcrm.dimensionsystems.com/resources/views/proposal/create.blade.php ENDPATH**/ ?>