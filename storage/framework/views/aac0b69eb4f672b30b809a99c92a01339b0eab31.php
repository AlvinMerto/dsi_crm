            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p><?php echo e(__('An Activity Log (also known as an Activity Diary or a Job Activity Log) is a written record of how you spend your time. By keeping an Activity Log for a few days, you can build up an accurate picture of what you do during the day, and how you invest your time.')); ?></p>
                        <div class="price">
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2><?php echo e(__('Activity ')); ?><b><?php echo e(__('Log')); ?></b><?php echo e(__(' Management')); ?></h2>
                <p><?php echo e(__('An activity log helps you see which part of the day is your most productive time. ')); ?></p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2><?php echo e(__('Why use Activity Log?')); ?></h2>
                        </div>
                        <p><?php echo e(__('Activity Logs are useful tools for analyzing how you use your time. They help you track changes in your energy, alertness and effectiveness throughout the day, and they help you eliminate time wasting activities so that you can be more productive.')); ?></p>
                    </div>
                </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2><?php echo e(__('How does the activity log work in Dash?')); ?></h2>
                        </div>
                        <p><?php echo e(__('The activity log shows you the activity happening within the modules along with time and according to the appropriate formate. For example, when you create a new object inside any module and edit it, the activity log will show you that activity.')); ?></p>
                    </div>
                </div>
...
<?php echo $__env->make('marketplace.marketplace', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dsi_crm\Modules/ActivityLog\Resources/views/marketplace/index.blade.php ENDPATH**/ ?>