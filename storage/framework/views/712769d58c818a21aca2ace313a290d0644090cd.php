            ...
            <div class="card">
                <div class="card-body">
                    <div class="collapse show float-end" id="collapseExample" style="">
                        <?php echo e(Form::open(array('route' => array('report.salesquotetotalcost'),'method'=>'get','class'=>'add_filter'))); ?>
                        ...
                        <div class="row filter-css">
                            ...
                            <div class="col-auto float-end ms-3 mt-1">
                                ...
                                <a href="<?php echo e(route('report.salesquotetotalcost')); ?>" data-bs-toggle="tooltip" data-title="<?php echo e(__('Reset')); ?>" title="<?php echo e(__('Reset')); ?>" class="btn btn-sm btn-danger"><i class="ti ti-trash-off"></i></a>
                    ...
                    <div class="table-responsive overflow_hidden">
                        <table class="table mb-0 pc-dt-simple" id="assets">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="sort" data-sort="budget"><?php echo e(__('Cost')); ?></th>
                            </tr>
                            </thead>
                            <tbody>
                            ...
                            <?php $__currentLoopData = $salesquotes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salesquote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <?php endif; ?>
                                    <td><?php echo e(currency_format_with_sym($salesquote->totalcost)); ?></td>
                                </tr>
            ...
            (function () {
                var options = {
                    ...
                    xaxis: {
                        categories: [],
                        title: {
                            text: '<?php echo e(__('SalesQuote Cost')); ?>'
                        },
                    },
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dimensionsystems/webcrm.dimensionsystems.com/Modules/Sales/Resources/views/report/salesquotecost.blade.php ENDPATH**/ ?>