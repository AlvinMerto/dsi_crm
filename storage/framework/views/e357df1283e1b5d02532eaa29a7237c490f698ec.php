            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p><?php echo e(__('Never lose a client to poor sales management ever again! Easily manage your sales, Calls, Documents, quotes, meeting schedule, Opportunities, and orders from one intuitive dashboard.')); ?></p>
                        <div class="price">
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2><?php echo e(__('Salesy Makes It Super Easy For You To Manage Your Sales')); ?></h2>
                <p><?php echo e(__('You can also find the individual overview of each of these elements broken down in percentages with their respective status.  Additionally, know the top due tasks, meeting schedule, and monthly calls on this dashboard.')); ?></p>
            </div>
            <div class="row row-gap padding-bottom ">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2><?php echo e(__('The Smartest Way To Manage Your Sales')); ?></h2>
                        </div>
                        <p><?php echo e(__('Salesy monitors your sales performance like a coach and lets you know whether you are on track. Get real time reports about every sales activity you make, make smarter decisions, and manage your business’s general sales more efficiently.')); ?> </p>
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span><?php echo e(__('Manage All Your Sales From One Place')); ?></span>
                                </a>
                                <div class="acnav-list">
                                    <p><?php echo e(__('Manage every aspect of your business sales from one place. Get sales updates on a daily, weekly or monthly basis. Monitor your sales, leads and accounts from a single comprehensive dashboard.')); ?></p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span><?php echo e(__('Access Your Clients’ Information')); ?></span>
                                </a>
                                <div class="acnav-list">
                                    <p><?php echo e(__('Easily view and control the details of all your clients. Create user accounts and edit existing user information, manage your contacts, and do a lot more from anywhere - with a single tool.')); ?></p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span><?php echo e(__('Manage All Your Sales Management Tasks Quickly And Easily From One Place')); ?></span>
                                </a>
                                <div class="acnav-list">
                                    <p><?php echo e(__('Control and keep track of your orders, invoices, and performance with ease. Easily track current trends, leads, and more. Schedule meetings, manage tasks, and carry out complex tasks in a few simple clicks.')); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row row-gap  padding-bottom">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2><?php echo e(__('Manage Your Sales From One Place')); ?></h2>
                        </div>
                        <p><?php echo e(__('Access a wide range of easily customizable features in one place.Get an overview of your invoices, quotes and sales order- all under one roof.')); ?></p>
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    <span class="acnav-icon">
                                    ...
                                    <span><?php echo e(__('Convert Quotes to Sales Order')); ?></span>
                                </a>
                                <div class="acnav-list">
                                    <p><?php echo e(__('Initially generated sales quotes can be altered, and updated as per the modification of the sales order on the particular sales quote.')); ?></p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span><?php echo e(__('Manage Your Payments Easily')); ?></span>
                                </a>
                                <div class="acnav-list">
                                    <p><?php echo e(__('Get paid for work done, fast. Integrate several payment options for diverse clients and make the payment process stress-free. Easily safeguard your clients’ payment by using Stripe, PayPal, Flutterwave, and more.')); ?></p>
                                </div>
                            </div>
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span><?php echo e(__('Get Instant Notifications')); ?></span>
                                </a>
                                <div class="acnav-list">
                                    <p><?php echo e(__('Integrate the Twilio app and never miss an important notification again. Get notified when tasks or orders are completed and get notifications about meetings and new orders sent to your mobile phone via text.')); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row row-gap align-items-center padding-bottom">
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2><?php echo e(__('Modify Vital Sales Info With Ease')); ?></h2>
                        </div>
                        <p><?php echo e(__('Modify and update your generated sales quotes with ease. Convert your quotes to invoices, get accurate information, and add new orders and products without stress.')); ?></p>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6 col-12">
                    <div class="dash-theme-preview">
            ...
            <div class="row row-gap align-items-center ">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2><?php echo e(__('Essential Information At Your Fingertips')); ?></h2>
                        </div>
                        <p> <?php echo e(__('Access a wide database of sales information under one tab. Easily filter through and sort details by different parameters. View invoices and orders, and manage information on a daily, weekly or monthly basis.')); ?></p>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('marketplace.marketplace', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DSI_Laravel\Modules/Sales\Resources/views/marketplace/index.blade.php ENDPATH**/ ?>