...
<div class="row">
    ...
    <?php } ?>
     ...
     <form method="post" action="<?php echo e(route('salesquote.postcreatequote')); ?>" class="w-100">
     <?php echo csrf_field(); ?>
        <?php
            if (isset($quoteid)) {
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
                                <div class="form-group" id="customer-box">
                                    ...
                                    <select name="customer_id" class="form-control" id="customer" data-url="<?php echo e(route('salesquote.getcustomers')); ?>" data-url1="<?php echo e(route('invoice.customer')); ?>" required="required">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="form-icon-user">
                                                <?php echo e(Form::date('issue_date',date('Y-m-d'), ["name"=>"issue_date", 'class' => 'form-control ', 'required' => 'required', 'placeholder' => 'Select Issue Date'])); ?>
...
<script>
    ...
    $(document).on("click","#email_quote", function(){
        ...
        postAjax("<?php echo e(route('salesquote.emailquote')); ?>", {quote_id : quote_id }, function(data){
            dis.html("<i class='ti ti-send'></i> Send Quotation </a>").removeAttr("disabled");
        }); 
    });
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\DSI_Laravel\Modules/Sales\Resources/views/salesquote/create.blade.php ENDPATH**/ ?>