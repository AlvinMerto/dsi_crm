    ...
    <tr class="subitem" data-rid="<?php echo $values['id']; ?>" data-itemorder="<?php echo $values['itemorderid']; ?>">
        ...
        <?php if (isset($showsettings['description'])) { ?>
            <td style='text-align:left;'>
                <?php if (!$intextbox) {?>
                    <textarea data-id="<?php echo $values['id']; ?>" data-fld="item" class='edittext form-control bold_input' style="text-align:left;" type='text'><?php echo $description; ?></textarea> 
                <?php } else { ?>
...
<?php /**PATH C:\xampp\htdocs\DSI_Laravel\Modules/Sales\Resources/views/salesquote/quote_item.blade.php ENDPATH**/ ?>