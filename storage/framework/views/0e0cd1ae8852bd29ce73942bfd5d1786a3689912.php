...
<?php $__env->startSection('page-action'); ?>
    <div class="btn-group" role="group">
        ...
        <div class="action-btn ms-2">
            <a href="<?php echo e(route('salesorder.edit',$previous)); ?>" class="btn btn-sm btn-primary btn-icon m-1" data-bs-toggle="tooltip" title="<?php echo e(__('Previous')); ?>">
        ...
        <?php if(!empty($next)): ?>
        <div class="action-btn  ms-2">
            <a href="<?php echo e(route('salesorder.edit',$next)); ?>" class="btn btn-sm btn-primary btn-icon m-1" data-bs-toggle="tooltip" title="<?php echo e(__('Next')); ?>">
                ...
                <div class="col-xl-3">
                    <div class="card sticky-top" style="top:30px">
                        <div class="list-group list-group-flush" id="useradd-sidenav">
                            ...
                            <a href="#useradd-2" class="list-group-item list-group-item-action border-0"><?php echo e(__('Sales Invoice')); ?> <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-9">
                    <div id="useradd-1" class="card">
                        <?php echo e(Form::model($salesOrder,array('route' => array('salesorder.update', $salesOrder->id), 'method' => 'PUT'))); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control">
                                                <?php $__currentLoopData = $quote; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($key); ?>" <?php if($salesOrder->quote_id == $key): ?> selected <?php endif; ?>> <?php echo e(\Modules\Sales\Entities\SalesQuote::quoteNumberFormat($value)); ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="status" id="status" class="form-control"  required>
                                                <?php $__currentLoopData = $status; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($k); ?>" <?php echo e(($salesOrder->status == $k) ? 'selected' : ''); ?>><?php echo e(__($v)); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::number('quote_number',null,array('class'=>'form-control','placeholder'=>__('Enter Quote Number'),'required'=>'required'))); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::select('tax[]', $tax,explode(',',$salesOrder->tax), array('class' => 'form-control choices','id'=>'choices-multiple1','multiple'=>'','required'=>'required'))); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <?php echo Form::select('user', $user, $salesOrder->user_id,array('class' => 'form-control')); ?>
                    ...
                    <div id="useradd-2" class="card">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="float-end">
                                        <a data-size="lg" data-url="<?php echo e(route('salesinvoice.create',['salesorder',$salesOrder->id])); ?>" data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>" data-title="<?php echo e(__('Create New Invoice')); ?>" class="btn btn-sm btn-primary btn-icon-only ">
                                                ...
                                                <td class="text-end">
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('salesinvoice show')): ?>
                                                        <div class="action-btn bg-warning ms-2">
                                                            <a href="<?php echo e(route('salesinvoice.show',$invoice->id)); ?>" data-bs-toggle="tooltip" data-original-title="<?php echo e(__('Details')); ?>" class="mx-3 btn btn-sm d-inline-flex align-items-center text-white" title="<?php echo e(__('Invoice Details')); ?>">
                                                                <i class="ti ti-eye"></i>
                                                            </a>
                                                        </div>
                                                    <?php endif; ?>
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('salesinvoice edit')): ?>
                                                        <div class="action-btn bg-info ms-2">
                                                            <a href="<?php echo e(route('salesinvoice.edit',$invoice->id)); ?>" data-bs-toggle="tooltip" data-original-title="<?php echo e(__('Edit')); ?>" class="mx-3 btn btn-sm d-inline-flex align-items-center text-white" title="<?php echo e(__('Edit Invoice')); ?>"><i class="ti ti-pencil"></i></a>
                                                        </div>
                                                    <?php endif; ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dimensionsystems/webcrm.dimensionsystems.com/Modules/Sales/Resources/views/salesorder/edit.blade.php ENDPATH**/ ?>