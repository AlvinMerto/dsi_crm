<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('SalesQuote Detail')); ?>
...
<?php $__env->startSection('action-btn'); ?>
    <?php if($salesquote->quote_status == 0): ?>
        <a href="<?php echo e(route('salesquote.email',['id'=>encrypt($salesquote->id),'type'=>'accept'])); ?>" class="btn  btn-primary">Accept</a>
        <a href="<?php echo e(route('salesquote.email',['id'=>encrypt($salesquote->id),'type'=>'reject'])); ?>" class="btn  btn-primary">Reject</a>
    <?php endif; ?>
<?php $__env->stopSection(); ?>
                    ...
                    <div class="invoice-print">
                        <div class="row invoice-title mt-2">
                            ...
                            <div class="col-xs-12 col-sm-12 col-nd-6 col-lg-6 col-12 text-end">
                                <h3 class="invoice-number">
                                    <?php echo e(Modules\Sales\Entities\SalesQuote::quoteNumberFormat($salesquote->quote_id, $salesquote->created_by,$salesquote->workspace)); ?></h3>
                            </div>
                            <div class="col-12">
                                <hr>
                            </div>
                        ...
                        <div class="row">
                                ...
                                <div class="d-flex align-items-center justify-content-end">
                                    <div class="me-4">
                                        <small>
                                            ...
                                            <?php echo e(company_date_formate($salesquote->issue_date,$salesquote->created_by,$salesquote->workspace)); ?><br><br>
                                        </small>
                                    </div>
                                </div>
                            ...
                            <br>
                                ...
                                <?php elseif($salesquote->quote_status==1): ?>
                        ...
                        <div class="row">
                            ...
                            <?php endif; ?>
                            <?php if(company_setting('invoice_shipping_display',$salesquote->created_by,$salesquote->workspace) == 'on'): ?>
                                ...
                                <div class="table-responsive mt-2">
                                    <table class="table mb-0 table-striped">
                                                        ...
                                                        <?php if(!empty($iteam->tax)): ?>
                                                            <table>
                                                                ...
                                                                <?php $__currentLoopData = $taxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    ...
                                                                    <tr>
                                                                        <td><?php echo e($tax->name . ' (' . $tax->rate . '%)'); ?></td>
                                                                        <td><?php echo e(currency_format_with_sym($taxPrice,$salesquote->created_by,$salesquote->workspace)); ?></td>
                                                                    </tr>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                <?php
                                                                    array_push($TaxPrice_array, $data);
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right"><b><?php echo e(__('TotalCost')); ?></b></td>
                                            <td class="text-right">
                                                <?php echo e(currency_format_with_sym($salesquote->totalcost(),$salesquote->created_by,$salesquote->workspace)); ?></td>
                                        </tr>
                                        <tr>
                                            <td colspan="<?php echo e($colspan); ?>"></td>
                                            <td class="text-right"><b><?php echo e(__('TotalProfit')); ?></b></td>
                                            <td class="text-right">
                                                <?php echo e(currency_format_with_sym($salesquote->totalProfit(),$salesquote->created_by,$salesquote->workspace)); ?></td>
                                        </tr>
                                        <tr>
                                            <td colspan="<?php echo e($colspan); ?>"></td>
                                            <td class="text-right"><b><?php echo e(__('GP')); ?></b></td>
                                            <td class="text-right">
                                                <?php echo e(currency_format_with_sym($salesquote->totalgp(),$salesquote->created_by,$salesquote->workspace)); ?></td>
                                        </tr>
                                        <tr>
                                            <td colspan="<?php echo e($colspan); ?>"></td>
                                            <td class="text-right"><b><?php echo e(__('Sub Total')); ?></b></td>
                                            <td class="text-right">
                                                <?php echo e(currency_format_with_sym($salesquote->totalextend(),$salesquote->created_by,$salesquote->workspace)); ?></td>
                                        </tr>
                                        <?php if(!empty($taxesData)): ?>
                                            <?php $__currentLoopData = $taxesData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taxName => $taxPrice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td class="text-right"><?php echo e(currency_format_with_sym($taxPrice,$salesquote->created_by,$salesquote->workspace)); ?>
                                        ...
                                        <tr>
                                            ...
                                            <?php if(!empty($taxesData)): ?>
                                                <td class="text-right">
                                                    <?php echo e(currency_format_with_sym($salesquote->totalextend() + $taxPrice,$salesquote->created_by,$salesquote->workspace)); ?></td>
                                            <?php else: ?>
                                                <td class="text-right">
                                                    <?php echo e(currency_format_with_sym($salesquote->totalextend(),$salesquote->created_by,$salesquote->workspace)); ?></td>
                                            <?php endif; ?>
...
<?php echo $__env->make('layouts.invoicepayheader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dimensionsystems/webcrm.dimensionsystems.com/Modules/Sales/Resources/views/salesquote/printview.blade.php ENDPATH**/ ?>