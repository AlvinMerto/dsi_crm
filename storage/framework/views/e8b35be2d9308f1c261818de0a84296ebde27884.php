...
<?php $__env->startSection('title'); ?>
    <?php echo e(__('SalesQuote Summary')); ?>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="collapse show float-end" id="collapseExample" style="">
                        <?php echo e(Form::open(array('route' => array('report.salesquotesummary'),'method'=>'get','class'=>'add_filter'))); ?>
                        ...
                        <div class="row filter-css">
                            ...
                            <div class="col-auto">
                                ...
                                <?php echo e(Form::select('employee',$employee,isset($_GET['employee'])?$_GET['employee']:'', array('class' => 'form-control '))); ?>
                            ...
                            <div class="col-auto float-end ms-3 mt-1">
                                ...
                                <a href="<?php echo e(route('report.salesquotesummary')); ?>" data-bs-toggle="tooltip" data-title="<?php echo e(__('Reset')); ?>" title="<?php echo e(__('Reset')); ?>" class="btn btn-sm btn-danger"><i class="ti ti-trash-off"></i></a>
                    ...
                    <div class="table-responsive overflow_hidden">
                        <table class="table mb-0 pc-dt-simple" id="assets">
                            ...
                            <tr>
                                ...
                                <th scope="col" class="sort" data-sort="budget"><?php echo e(__('Sales')); ?></th>
                            </tr>
                            </thead>
                            <tbody>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dimensionsystems/webcrm.dimensionsystems.com/Modules/Sales/Resources/views/report/salesquotesummary.blade.php ENDPATH**/ ?>