<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Sales Quote Edit')); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        $(document).on('click','.delete-item',function () {
            ...
            $.ajax({
                url: '<?php echo e(route('salesquote.item.delete')); ?>',
                type: 'POST',
                headers: {
        ...
        function SectionGet(type = 'salesquote',project_id = "0",title = 'SalesQuote'){
            ...
            $.ajax({
                ...
                data: {
                    ...
                    acction: acction,
                    invoice_id: <?php echo e($salesquote->id); ?>,
                },
                beforeSend: function () {
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <?php echo e(Form::model($salesquote, array('route' => array('salesquote.update', $salesquote->id), 'method' => 'PUT','class'=>'w-100'))); ?>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group" id="customer-box">
                                ...
                                <?php echo e(Form::select('customer_id', $customers,!empty($salesquote->customer_id) ? $salesquote->customer_id: null, array('class' => 'form-control ','id'=>'customer','data-url'=>route('invoice.customer'),'required'=>'required','placeholder' =>'Select Customer'))); ?>
                        ...
                        <div class="col-md-3">
                            <div class="form-group" id="customer-box">
                                <?php echo e(Form::label('contact_person', __('Contact Person'),['class'=>'form-label'])); ?>
                                  ...
                                  <span class="text-danger">*</span>
                                <?php echo e(Form::select('contact_person', $users,!empty($salesquote->contact_person) ? $salesquote->contact_person: null, array('class' => 'form-control ','id'=>'contact_person','data-url'=>route('invoice.customer'),'required'=>'required','placeholder' =>'Select Contact Person'))); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-icon-user">
                                            <?php echo e(Form::date('issue_date',null,array('class'=>'form-control ','required'=>'required','placeholder'=>'Select Customer'))); ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <?php echo e(Form::label('invoice_number', __('Quote Number'),['class'=>'form-label'])); ?>
                                          ...
                                          <span class="text-danger">*</span>
                                        <div class="form-icon-user">
                                            <input type="text" class="form-control" value="<?php echo e($salesquote_number); ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dimensionsystems/webcrm.dimensionsystems.com/Modules/Sales/Resources/views/salesquote/edit.blade.php ENDPATH**/ ?>