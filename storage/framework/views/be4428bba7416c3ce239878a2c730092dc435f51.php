                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class='with_as' style='padding-left:0px;text-align: right;'>
                            <a class="border-right" id="email_quote" title="Send Quotation" data-size="md" data-toggle="tooltip" title="<?php echo e(__('Comment')); ?>"> 
                                <i class="ti ti-send"></i> <span> Send Quotation </span> 
                            </a>
                            <a class="border-right" href="<?php echo e(route('quote.pdf', [$qid])); ?>" target='_blank' title="Download Quotation" data-toggle="tooltip" title="<?php echo e(__('Comment')); ?>"> 
                                <i class="ti ti-download"></i> <span> Download Quotation </span> 
                            </a>
                            <a class="border-right" href="<?php echo e(route('quote.displayquote', [$qid])); ?>" target='_blank' title="Sent Preview Quotation" data-toggle="tooltip" title="<?php echo e(__('Comment')); ?>"> 
                                <i class="ti ti-presentation"></i> <span> Sent Preview Quotation </span> 
                            </a>
                            <a class="border-right" href="<?php echo e(route('quote.printpreview', [$qid])); ?>" target='_blank' title="Print Preview Quotation" data-toggle="tooltip" title="<?php echo e(__('Comment')); ?>"> 
