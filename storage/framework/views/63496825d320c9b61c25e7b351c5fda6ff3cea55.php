...
<head>
    ...
    <title><?php echo e(Modules\Sales\Entities\SalesInvoice::invoiceNumberFormat($invoice->invoice_id,$invoice->created_by,$invoice->workspace)); ?> | <?php echo e(!empty(company_setting('title_text',$invoice->created_by,$invoice->workspace)) ? company_setting('title_text',$invoice->created_by,$invoice->workspace) : (!empty(admin_setting('title_text')) ? admin_setting('title_text') :'WorkDo')); ?></title>
    <link
    ...
    <div class="invoice-preview-main" id="boxes">
            ...
            <table>
                <tbody>
                    <tr style="border-bottom:1px solid var(--theme-color);">
                        ...
                        <td class="text-right">
                            <h3 style="text-transform: uppercase; font-size: 40px; font-weight: bold; color: <?php echo e($color); ?>;"><?php echo e(__('Sales Invoice')); ?></h3>
                        </td>
                    </tr>
                </tbody>
            </table>
                            ...
                            <table class="no-space">
                                <tbody>
                                    <tr>
                                        <td colspan="2" >
                                            <div class="view-qrcode" style="margin-top: 0; margin-bottom: 15px;">
                                                <p> <?php echo DNS2D::getBarcodeHTML(route('pay.salesinvoice',\Illuminate\Support\Facades\Crypt::encrypt($invoice->id)), "QRCODE",2,2); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><?php echo e(Modules\Sales\Entities\SalesInvoice::invoiceNumberFormat($invoice->invoice_id,$invoice->created_by,$invoice->workspace)); ?></td>
                                    </tr>
                                    <tr>
                                        <td><?php echo e(__('Issue Date:')); ?></td>
                                        <td class="text-right"><?php echo e(company_date_formate($invoice->issue_date,$invoice->created_by,$invoice->workspace)); ?></td>
                                    </tr>
                                    <?php if(!empty($customFields) && count($invoice->customField)>0): ?>
                                        <?php $__currentLoopData = $customFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($field->name); ?> :</td>
                                                <td class="text-right" style="white-space: normal;"> <?php echo e(!empty($invoice->customField[$field->id])?$invoice->customField[$field->id]:'-'); ?></td>
                                            </tr>
        ...
        <div class="invoice-body">
            <table>
                <tbody>
                    <tr>
                        ...
                        <?php if($settings['salesinvoice_shipping_display']=='on'): ?>
                            <td class="text-right">
            ...
            <table class="add-border invoice-summary" style="margin-top: 30px;">
                    ...
                    <?php if(isset($invoice->items) && count($invoice->items) > 0): ?>
                        <?php $__currentLoopData = $invoice->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e(currency_format_with_sym($item->price,$invoice->created_by,$invoice->workspace)); ?></td>
                                <td><?php echo e(($item->discount!=0)?currency_format_with_sym($item->discount,$invoice->created_by,$invoice->workspace):'-'); ?></td>
                                <td>
                                ...
                                <td><?php echo e(currency_format_with_sym($item->price * $item->quantity,$invoice->created_by,$invoice->workspace)); ?></td>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td><?php echo e(currency_format_with_sym($invoice->totalRate,$invoice->created_by,$invoice->workspace)); ?></td>
                        <td><?php echo e(currency_format_with_sym($invoice->totalDiscount,$invoice->created_by,$invoice->workspace)); ?></td>
                        <td><?php echo e(currency_format_with_sym($invoice->totalTaxPrice,$invoice->created_by,$invoice->workspace)); ?></td>
                        <td><?php echo e(currency_format_with_sym($invoice->getSubTotal(),$invoice->created_by,$invoice->workspace)); ?></td>
                    </tr>
                    <tr>
                        <td colspan="4"></td>
                            ...
                            <table class="total-table">
                                <?php if($invoice->getTotalDiscount()): ?>
                                    <tr>
                                        ...
                                        <td><?php echo e(currency_format_with_sym($invoice->getTotalDiscount(),$invoice->created_by,$invoice->workspace)); ?></td>
                                    </tr>
                                <?php endif; ?>
                                ...
                                <tr>
                                    <td><?php echo e(__('Total')); ?>:</td>
                                    <td><?php echo e(currency_format_with_sym(($invoice->getSubTotal()-$invoice->getTotalDiscount()+$invoice->getTotalTax()),$invoice->created_by,$invoice->workspace)); ?></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
            ...
            <div class="invoice-footer">
                <p> <?php echo e($settings['salesinvoice_footer_title']); ?> <br>
                    <?php echo e($settings['salesinvoice_footer_notes']); ?> </p>
            </div>
        </div>
    </div>
    <?php if(!isset($preview)): ?>
        <?php echo $__env->make('sales::salesinvoice.script', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>;
    <?php endif; ?>
</body>

</html>
<?php /**PATH /home/dimensionsystems/webcrm.dimensionsystems.com/Modules/Sales/Resources/views/salesinvoice/templates/template8.blade.php ENDPATH**/ ?>