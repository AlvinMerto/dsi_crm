...
@push('scripts')
    ...
    <script src="{{ Module::asset('SupportTicket:Resources/assets/js/editorplaceholder.js') }}"></script>
    <script src="{{ Module::asset('SupportTicket:Resources/assets/js/jquery-ui.min.js') }}"></script>
    <script src="{{ Module::asset('SupportTicket:Resources/assets/js/repeater.js') }}"></script>
