...
@section('page-action')
    ...
    <div class="col-auto ps-1 pt-2">
        @can('ticket create')
                <a href="{{route('support-tickets.create', ['supporttickets', 0])}}" class="btn btn-sm btn-primary btn-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Create')}}"><i class="ti ti-plus text-white"></i></a>
        @endcan
    </div>
