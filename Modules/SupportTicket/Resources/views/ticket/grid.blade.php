                        ...
                        <div class="card-header-right">
                            <div class="btn-group card-option">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    @if (Gate::check('ticket show') || Gate::check('ticket edit') || Gate::check('ticket delete'))
                                        @can('ticket show')
...
@endsection
@push('scripts')
    <script src="{{ Module::asset('SupportTicket:Resources/assets/js/letter.avatar.js') }}"></script>
@endpush
