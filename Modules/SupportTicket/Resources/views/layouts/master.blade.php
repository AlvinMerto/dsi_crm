...
<head>
    ...
    <title>@yield('page-title') |
        {{ !empty(company_setting('title_text', $workspace->created_by, $workspace->id)) ? company_setting('title_text', $workspace->created_by , $workspace->id) : (!empty(admin_setting('title_text')) ? admin_setting('title_text') : 'WorkDo') }}
    </title>
