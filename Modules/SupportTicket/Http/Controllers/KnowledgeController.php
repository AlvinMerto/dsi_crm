...
class KnowledgeController extends Controller
{
    ...
    {
        if (Auth::user()->can('knowledgebase manage')) {
            $knowledges = KnowledgeBase::where('workspace_id', getActiveWorkSpace())->get();
    ...
    {
        if (Auth::user()->can('knowledgebase create')) {
    ...
    {
        if (Auth::user()->can('knowledgebase edit')) {
            $userObj = \Auth::user();
    ...
    {
        if (Auth::user()->can('knowledgebase delete')) {
            $knowledge = KnowledgeBase::find($id);
            $knowledge->delete();
    ...
    {
        if (Auth::user()->can('knowledgebase import')) {
