...
class KnowledgebaseCategoryController extends Controller
{
    ...
    {
        if (Auth::user()->can('knowledgebasecategory manage')) {
    ...
    {
        if (Auth::user()->can('knowledgebasecategory create')) {
    ...
    {
        $userObj = \Auth::user();
        if (Auth::user()->can('knowledgebasecategory edit')) {
    ...
    {
        $user = \Auth::user();
        if (Auth::user()->can('knowledgebasecategory delete')) {
