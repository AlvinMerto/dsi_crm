...
class TicketCategoryController extends Controller
{
    ...
    {
        if (Auth::user()->can('ticketcategory manage')) {
    ...
    {
        if (Auth::user()->can('ticketcategory create')) {
    ...
    {
        if (Auth::user()->can('ticketcategory edit')) {
            $userObj = \Auth::user();
    ...
    {
        if (Auth::user()->can('ticketcategory delete')) {
