    <tr class="subitem" data-rid="<?php echo $values['id']; ?>">
        ...
        <td> 
            <?php if ($type == "comment") { ?>
                <textarea  data-id="<?php echo $values['id']; ?>" data-fld="item" style="text-align:left;" class='edittext form-control bold_input' type='text'><?php echo $description; ?></textarea>
            <?php } else { ?>
