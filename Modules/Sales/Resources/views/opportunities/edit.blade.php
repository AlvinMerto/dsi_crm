...
{{--                                    class="float-end"><i class="ti ti-chevron-right"></i></div></a>--}}
                            ...
                            <a href="#useradd-7"
                               class="list-group-item list-group-item-action border-0">{{ __('Notes') }} <div
                                        class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                            <a href="#useradd-8"
                               class="list-group-item list-group-item-action border-0">{{ __('All Activity') }} <div
                                        class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <form>
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <b>Date Created: {{company_date_formate($opportunities->created_at)}} Created By: {{isset($opportunities->createuser)?$opportunities->createuser->name:""}}</b><br>
                                            <b>Date Updated: {{company_date_formate($opportunities->created_at)}} Updated By: {{isset($opportunities->updateuser)?$opportunities->updateuser->name:""}}</b>
                                        </div>
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col">
                                    <h5>{{ __('Notes') }}</h5>
                                    <small
                                            class="text-muted">{{ __('Assigned Notes for this opportunities') }}</small>
                                </div>
                                <div class="col">
                                    <div class="float-end">
                                        <a data-size="lg"
                                           data-url="{{ route('notes.create',['opportunity', $opportunities->id])  }}"
                                           data-ajax-popup="true" data-bs-toggle="tooltip" title="{{ __('Create') }}"
                                           data-title="{{ __('Create New Notes') }}"
                                           class="btn btn-sm btn-primary btn-icon-only">
                                            <i class="ti ti-plus"></i>
                                        </a>
                                    </div>
