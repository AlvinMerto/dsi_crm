        ...
        <div class="row">
            ...
            @if($type == 'account')
                <div class="col-6">
                    <div class="form-group">
                        ...
                        {!!Form::select('account', $account_name, $id,array('class' => 'form-control select_data_account','required'=>'required','placeholder'=>'Select Account')) !!}
                    </div>
                </div>
            @else
                <div class="col-6">
                    <div class="form-group">
                        ...
                        {!!Form::select('account', $account_name, null,array('class' => 'form-control select_data_account','required'=>'required','placeholder'=>'Select Account')) !!}
                    </div>
                </div>
            @endif
            @if($type == 'contact')
            ...
            @else
                <div class="form-group col-md-6">
                    ...
                    <select class="form-control {{ !empty($errors->first('contact')) ? 'is-invalid' : '' }} contact_data"
