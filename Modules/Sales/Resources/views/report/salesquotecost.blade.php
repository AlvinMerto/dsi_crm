            ...
            <div class="card">
                <div class="card-body">
                    <div class="collapse show float-end" id="collapseExample" style="">
                        {{ Form::open(array('route' => array('report.salesquotetotalcost'),'method'=>'get','class'=>'add_filter')) }}
                        <div class="row filter-css">
                            ...
                            <div class="col-auto float-end ms-3 mt-1">
                                ...
                                <a href="{{route('report.salesquotetotalcost')}}" data-bs-toggle="tooltip" data-title="{{__('Reset')}}" title="{{__('Reset')}}" class="btn btn-sm btn-danger"><i class="ti ti-trash-off"></i></a>
...
{{--                                @endif--}}
                                ...
                                <th scope="col" class="sort" data-sort="budget">{{ __('Cost') }}</th>
                            </tr>
                            </thead>
                            <tbody>
...
{{--                                    @endif--}}
                                    ...
                                    @endif
                                    <td>{{ currency_format_with_sym($salesquote->totalcost) }}</td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
