                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('opportunity',$opportunity, null , ['id' => 'opportunity','class'=>"form-control choices",'searchEnabled'=>'true','placeholder' => __('Select Opportunity')]) }}
{{--                                        {!! Form::select('opportunity', $opportunity, null,array('class' => 'form-control')) !!}--}}
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        {{Form::text('quote_number',null,array('class'=>'form-control','placeholder'=>__('Enter Quote Number'),'required'=>'required','readonly'))}}
{{--                                        {{Form::text('quote_number',$quote_number,array('class'=>'form-control','placeholder'=>__('Enter Quote Number'),'required'=>'required'))}}--}}
                                        @error('quote_number')
