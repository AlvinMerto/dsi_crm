                                    ...
                                    <div class="table-responsive mt-2">
                                        <table class="table mb-0">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text- subTotal">{{currency_format_with_sym( $quote->thetotal(),$quote->created_by,$quote->workspace)}}</td>
                                            </tr>
                                            </tfoot>
                                            </tbody>
                                        </table>
                                            ...
                                            <div class="row justify-content-between align-items-center">
                                                <div class="col-md-6 order-md-2 mb-4 mb-md-0">
                                                    <div class="d-flex align-items-center justify-content-md-end">
                                                        ...
                                                        <span class="h4 mb-0">{{currency_format_with_sym($quote->thetotal(),$quote->created_by,$quote->workspace)}}</span>
                                                    </div>
                                                </div>
