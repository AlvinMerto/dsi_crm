        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    {{ Form::select('opportunity',$opportunities, null , ['id' => 'opportunity','class'=>"form-control choices",'searchEnabled'=>'true','placeholder' => __('Select Opportunity')]) }}
                </div>
            </div>
            <div class="col-6">
                <div class="form-group">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    {{ Form::text('quote_number',$quote_number, ['class' => 'form-control', 'placeholder' => __('Enter Quote Number'), 'required' => 'required','readonly']) }}
                </div>
            </div>
            <div class="col-6">
                <div class="form-group">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <select class="form-control {{ !empty($errors->first('billing_contact')) ? 'is-invalid' : '' }} contact_data"
                            name="billing_contact" id="billing_contact">
                    </select>
                    <div class="invalid-feedback">
                        {{ $errors->first('billing_contact') }}
                    </div>
                </div>
            </div>
            <div class="col-6">
                <div class="form-group">
                    ...
                    <select class="form-control {{ !empty($errors->first('shipping_contact')) ? 'is-invalid' : '' }} contact_data"
                            name="shipping_contact" id="shipping_contact">
                    </select>
                    <div class="invalid-feedback">
                        {{ $errors->first('shipping_contact') }}
                    </div>
                </div>
            </div>
            <div class="col-6">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    {!! Form::select('shipping_provider', $shipping_provider, null, ['class' => 'form-control '  ,'placeholder' => 'Shipping Provider']) !!}
                </div>
            </div>
            <div class="col-12">
                <div class="form-group">
