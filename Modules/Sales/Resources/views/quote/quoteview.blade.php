...
<a href="">
    ...
    <span class="btn-inner--text text-white">{{__('Accept')}}</span>
</a>
<a href="">
     <span class="btn-inner--icon text-white"><i class="fa fa-print"></i></span>
    <span class="btn-inner--text text-white">{{__('Reject')}}</span>
</a>
<a href="{{route('quote.pdf',\Crypt::encrypt(1))}}" target="_blank" class="btn btn-sm btn-primary btn-icon ">
    <span class="btn-inner--icon text-white"><i class="fa fa-print"></i></span>
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div id='pricing'>
                                            ...
                                            <div>
                                                ...
                                                <?php } else { ?>
                                                    <p style="text-align: right;padding: 0px 0px; margin:10px;"> <strong> Subtotal </strong> &nbsp; &nbsp; &nbsp; <span> {{ company_setting('defult_currancy_symbol') }}<?php echo $total['totalamount']; ?> </span> </p>
                                                <?php } ?>
                                                <p style="text-align: right;padding: 0px 0px; margin:10px;">  <strong> Total </strong> &nbsp; &nbsp; &nbsp; <span> {{ company_setting('defult_currancy_symbol') }}<?php echo $total['totalamount']; ?> </span> </p>
                                            </div>
                                        </div>
                                        <?php if ($qt_valid) { ?>
                                            <div class="card my-5">
