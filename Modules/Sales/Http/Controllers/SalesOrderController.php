...
class SalesOrderController extends Controller
{
    ...
    public function create($type,$id)
    {
        if(\Auth::user()->can('salesorder create'))
        {
            ...
            $quote = SalesQuote::where('created_by',creatorId())->where('workspace',getActiveWorkSpace())->get()->pluck('quote_id','id');
            $quote->prepend('--', '');
    ...
    public function store(Request $request)
    {
        if(\Auth::user()->can('salesorder create'))
        {
            ...
            $salesorder['updated_by']          = creatorId();
            $salesorder->save();
    ...
    public function opportunitydetail(Request $request)
    {

        $opportunities=Opportunities::where('contact',$request->contact_id)->get();


        $opportunity="<option value=''>Select Opportunity</option>";
        foreach($opportunities as $value)
        {
            $opportunity .= "<option value='".$value->id."'>".$value->name."</option>";
