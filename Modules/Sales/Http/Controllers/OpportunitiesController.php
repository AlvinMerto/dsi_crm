...
class OpportunitiesController extends Controller
{
    ...
    public function index()
    {
        ...
        {
            $opportunitiess = Opportunities::where('workspace',getActiveWorkSpace())->orderBy('created_at','DESC')->get();
    ...
    public function store(Request $request)
    {
        if(\Auth::user()->can('opportunities create'))
        {
            ...
            $opportunities['updated_by']  = creatorId();
            $opportunities->save();
    ...
    public function edit($id)
    {
        if(\Auth::user()->can('opportunities edit'))
        {
            ...
            $notes=Notes::where('opportunity_id',$opportunities->id)->get();
            $allactivities=AllActivityLog::where('opportunity_id',$opportunities->id)->get();


            return view('sales::opportunities.edit', compact('opportunities','salesorders','quotes','salesinvoices', 'user','stages', 'lead_source','account_name', 'contact', 'documents', 'streams', 'previous', 'next','notes','allactivities'));
        }
        else
        {
            return redirect()->back()->with('error', 'permission Denied');
