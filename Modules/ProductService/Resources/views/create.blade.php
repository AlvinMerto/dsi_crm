    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="form-icon-user">
                    {{ Form::number('purchase_price', '', ['class' => 'form-control', 'required' => 'required', 'step' => '0.01','id'=> 'cost']) }}
                </div>
            </div>
        </div>
        <div class="form-group col-md-6 markup">
            ...
            {{ Form::number('markup', null, ['class' => 'form-control', 'required' => 'required', 'min'=>'0','id'=>'markup']) }}
        </div>

        <div class="form-group col-md-6 quantity">
            {{ Form::label('quantity', __('Quantity'), ['class' => 'form-label']) }}
            <span class="text-danger">*</span>
            {{ Form::number('quantity', null, ['class' => 'form-control', 'min'=>'0', 'required' => 'required','id'=>'quantity']) }}
        </div>
        ...
        <div class="col-md-6">
            <div class="form-group">
                {{ Form::label('sale_price', __('Price'), ['class' => 'form-label']) }}<span
                    class="text-danger">*</span>
                <div class="form-icon-user">
                    {{ Form::number('sale_price', '', ['class' => 'form-control', 'required' => 'required', 'step' => '0.01','id' => 'price']) }}
                </div>
            </div>
        </div>
