                    ...
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
                            <div class="section-title">
                                ...
                                <h2>{{ __('What are the benefits of using Assets?') }}</h2>
                            </div>
                            <p>{{ __('First, let’s talk a little about the difference between asset management and asset tracking. The short version is that management refers to the holistic process of overseeing high-value assets - like equipment, tools or even people.  This process should include a written plan, along with organizational accountability measures.') }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
                            <div class="section-title">
                                ...
                                <h2>{{ __('What Is an Asset?') }}</h2>
                            </div>
                            <p>{{ __('An asset is a resource with economic value that an individual, corporation, or country owns or controls with the expectation that it will provide a future benefit.
