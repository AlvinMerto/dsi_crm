...
@php
    $path = url("/Modules/Notes/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('Razorpay ')}}<b>{{__('Payment ')}}</b>{{__(' Getway')}}</h2>
                <p>{{__('Razorpay is an online payment processing and credit card processing platform for businesses.')}}</p>
            </div>
