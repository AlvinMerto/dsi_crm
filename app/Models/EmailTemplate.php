...
class EmailTemplate extends Model
{
    ...
    public static function sendEmailTemplate($emailTemplate, $mailTo, $obj, $user_id = null, $workspace_id = null, $subject = null)
    {
        if (!empty($user_id)) {
        ...
        if (isset($template) && !empty($template)) {
            ...
            if (!empty($content->content)) {
                ...
                if (!empty(company_setting('mail_from_address', $user_id, $workspace_id))) {
                    ...
                    if ($setconfing ==  true) {
                        try {
                            Mail::to($mailTo)->send(new CommonEmailTemplate($content, $user_id, $workspace_id, $subject));
                        } catch (\Exception $e) {
                            dd($e);
                            $error = $e->getMessage();
                        }
