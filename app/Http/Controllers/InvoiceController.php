...
//        dd($request->all());
        ...
        $data['markup']        = !empty($product) ? ((!empty($product->markup)) ? $product->markup : '') : '';
        $data['manufacturer_part_number']        = !empty($product) ? ((!empty($product->manufacturer_part_number)) ? $product->manufacturer_part_number : '') : '';
        $data['manufacturer_name']        = !empty($product) ? ((!empty($product->manufacturer_name)) ? $product->manufacturer_name : '') : '';
        $data['supplier_part_number']        = !empty($product) ? ((!empty($product->supplier_part_number)) ? $product->supplier_part_number : '') : '';
        $data['supplier_name']        = !empty($product) ? ((!empty($product->supplier_name)) ? $product->supplier_name : '') : '';
        ...
        $data['purchase_price'] = !empty($product) ? ( !empty($product->purchase_price) ? $product->purchase_price : 0) : 0;
    ...
    public function InvoiceSectionGet(Request $request)
    {
        ...
        if($acction == 'edit')
        {
            if($request->type=="salesquote")
            {
                $invoice=SalesQuote::find($request->invoice_id);
            }
            else
            {
        ...
        elseif($request->type == "salesquote" && module_is_active('Sales'))
        {
